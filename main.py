...
👨‍💻 **Developer :** [Fayas](https://github.com/ALBINPRAVEEN)
👥 **Group :** [Developer Team](https://telegram.me/musicwithalby)
...
BUTTONS = [InlineKeyboardButton('⚙ Join Updates Channel ⚙', url='https://telegram.me/musicwithalby')]
...
async def translate(bot, update, text):
    ...
    try:
        ...
        print(error)
        await message.edit_text("Something wrong. Contact @i_am_albin_praveen.")
        return
